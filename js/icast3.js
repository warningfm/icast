                ...
                success:
                    function(data) {						
                        if (data.results.length == 1){							
                            ...
                            //var cover = settings.logo; //This image will be used when no album cover available.
                            ...
                            if (artist == 'Commercial Break') {var cover = Commercial_Break;}
                             else if (artist == 'Bintang Tenggara') {var cover = Bintang_Tenggara;}
                             else if (artist == 'JINGLE SETELAH IKLAN') {var cover = JINGLESETELAHIKLAN;}
                             else if (artist == 'TS') {var cover = TS;}
